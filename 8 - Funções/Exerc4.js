...
function IntervaloEntreNumeros(numero1, numero2) {
  ...
  //garante que o menor número fique armazenado na variável inicio e o maior número na variável fim. Isso é útil para situações onde precisamos definir um intervalo numérico ordenado, independentemente da ordem em que numero1 e numero2 são fornecidos.
